...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 07, 2024 at 06:09 AM
...
INSERT INTO `siswa` (`nis`, `nama`, `jeniskelamin`, `asalsekolah`, `alamat`) VALUES
(2, 'Rizky', 'Laki-Laki', 'SMA 2', 'Kayu Tangi');
...
INSERT INTO `transaksi` (`idpembayaran`, `nis`, `nama`, `biayamasuk`, `uangpangkal`) VALUES
(123, 22, 'Ahmad Rizky', '350000', '2500000');
...
--
ALTER TABLE `transaksi`
  MODIFY `idpembayaran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1235;
COMMIT;
